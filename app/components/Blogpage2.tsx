...
const CATEGORIES = [
  ...
  { name: "Business", count: "02", active: true }, // Active category for this post
...
/* ──────────────────────────────────────────────────────────
   MAIN COMPONENT — BLOG DETAILS PAGE 2
────────────────────────────────────────────────────────── */
export default function Blogpage2(): React.ReactElement {
      ...
      <section className="max-w-[1300px] mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            {/* Post Navigation (Previous + Grid + Next) */}
            <motion.div variants={fadeUp} className="w-full bg-[#eef0ee] rounded-[16px] mt-10 mb-14 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between px-8 py-6 relative">
                ...
                <div className="w-1/3 flex justify-start">
                  <Link href="/blogpage1" className="flex items-center gap-3 text-[#222629] font-extrabold text-[16px] hover:text-[#86C232] group transition-colors">
