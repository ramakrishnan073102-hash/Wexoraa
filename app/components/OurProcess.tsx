...
export default function OurProcessSection(): React.ReactElement {
  return (
    <section className="relative w-full bg-white p-4 sm:p-6 md:p-10 overflow-hidden font-['Manrope',_sans-serif]">
      ...
      {/* ── LIGHT BACKGROUND (Matches HomeAbout) ── */}
      <div 
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-16 md:mb-24">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 border-[1.5px] border-[#86C232]/40 bg-[#86C232]/10 backdrop-blur-md rounded-[6px] px-4 py-1.5 text-[#86C232] text-xs font-extrabold uppercase tracking-[0.2em] mb-6 shadow-sm"
            >
          ...
          <div className="relative pt-6">
            ...
            <motion.div 
              ...
              className="hidden md:block absolute top-[44px] left-[10%] right-[10%] h-[1px] border-t-[2px] border-dashed border-[#474B4F]/15 origin-left z-0"
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 relative z-10 w-full">
              {PROCESS_STEPS.map((step, index) => (
                <div key={step.id} className="flex flex-col items-center md:items-start relative w-full group">
                  ...
                  {/* GLOSSY STEP PILL (Wexoraa Green Tint) */}
                  <motion.div
                  ...
                  >
                    <span className="relative overflow-hidden bg-[#86C232]/10 backdrop-blur-xl border-[1.5px] border-[#86C232]/30 text-[#86C232] text-[0.85rem] font-extrabold px-8 py-2.5 rounded-full tracking-wide shadow-[0_0_0_8px_#EAF0ED] group-hover:border-[#86C232]/60 group-hover:bg-[#86C232]/20 transition-all duration-300">
                  ...
                  <motion.div
                    ...
                    className={`hidden md:block absolute top-[44px] left-1/2 -translate-x-1/2 w-[1px] border-l-[2px] border-dashed border-[#474B4F]/15 origin-top z-0 ${step.lineHeight}`}
                  />

                  {/* ── GLOSSY WEXORAA INNER CARD (White color removed) ── */}
                  <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.6 + index * 0.2, ease: [0.16, 1, 0.3, 1] }}
                    className={`relative w-full p-8 md:p-10 rounded-[28px] overflow-hidden bg-gradient-to-br from-[#86C232]/10 to-[#222629]/[0.03] backdrop-blur-xl border border-[#86C232]/20 shadow-[0_8px_32px_rgba(34,38,41,0.05)] transition-all duration-500 group-hover:-translate-y-2 group-hover:border-[#86C232]/40 group-hover:from-[#86C232]/15 group-hover:to-[#86C232]/10 group-hover:shadow-[0_25px_50px_-12px_rgba(134,194,50,0.15)] ${step.margin}`}
                  >
                    ...
                    {/* Background Number */}
                    <div className="text-[90px] md:text-[110px] leading-[0.8] font-black tracking-tighter mb-6 bg-gradient-to-b from-[#86C232]/30 to-transparent bg-clip-text text-transparent select-none relative z-10 transition-colors duration-500 group-hover:from-[#86C232]/60">
                      {step.id}
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-[0.95rem] leading-[1.7] text-[#474B4F] font-medium">
                        {step.desc}
                      </p>
                    </div>
                  </motion.div>
