...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Pages", href: "#", mega: true },
  {
    ...
    children: [
      { label: "Business Strategy Development",   href: "/strategy",  icon: Blocks,    desc: "Customized corporate execution models" },
      { label: "Customer Experience Solutions",   href: "/cx",        icon: Radar,     desc: "Seamless journeys that build loyalty"  },
      { label: "Sustainability & ESG Consulting", href: "/esg",       icon: Leaf,      desc: "Actionable ESG frameworks"             },
      { label: "Training Development Programs",   href: "/training",  icon: Sun,       desc: "Upskill employees & align objectives"  },
      { label: "IT Support & Maintenance",        href: "/it",        icon: Cpu,       desc: "Reliable tech support for your team"   },
      { label: "Marketing Strategy & Campaigns",  href: "/marketing", icon: Megaphone, desc: "Data-driven marketing execution"       },
    ],
  },
  {
...
const MEGA_COLS: MegaCol[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Blog Grid",         href: "/blog-grid",    badge: { text: "New", color: "#86C232" } },
