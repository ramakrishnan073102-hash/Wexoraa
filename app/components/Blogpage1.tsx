...
const CATEGORIES = [
  { name: "Corporate", count: "02", active: true },
...
/* ──────────────────────────────────────────────────────────
   MAIN COMPONENT — BLOG DETAILS PAGE 1
────────────────────────────────────────────────────────── */
export default function Blogpage1(): React.ReactElement {
      ...
      <section className="max-w-[1300px] mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            {/* Paragraphs */}
            <motion.div variants={fadeUp} className="space-y-6 text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-4">
              <p>
            ...
            {/* Checklist Grid */}
            <motion.div variants={fadeUp} className="grid grid-cols-1 sm:grid-cols-2 gap-y-5 gap-x-8 mb-10">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-6 border-y border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-[#eef0ee] text-[#6B6E70] px-4 py-1.5 rounded-[6px] text-[13px] font-bold hover:bg-[#86C232] hover:text-white transition-colors cursor-pointer">Corporate</span>
                <span className="bg-[#eef0ee] text-[#6B6E70] px-4 py-1.5 rounded-[6px] text-[13px] font-bold hover:bg-[#86C232] hover:text-white transition-colors cursor-pointer">Business</span>
              </div>
              <div className="flex items-center gap-4">
            ...
            <motion.div variants={fadeUp} className="w-full bg-[#eef0ee] rounded-[16px] mt-10 mb-14 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between px-8 py-6 relative">
                ...
                {/* Previous Button Placeholder (Empty on first post) */}
                <div className="w-1/3 flex justify-start">
                  <span className="opacity-0 cursor-default">Previous</span>
                </div>
            ...
            <motion.div variants={fadeUp} className="bg-[#f8f9f8] border border-gray-200 p-10 md:p-12 rounded-[24px]">
              ...
              <form className="space-y-6">
                ...
                <div className="mt-8">
                  {/* Rotating Arrow Submit Button matching video style */}
