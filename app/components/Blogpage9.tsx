...
const CATEGORIES = [
  ...
  { name: "Innovations", count: "01", active: true }, // Highlighted for this post
...
────────────────────────────────────────────────────────── */
export default function Blogpage9(): React.ReactElement {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-[2.2rem] md:text-[2.8rem] font-extrabold text-[#222629] leading-[1.2] tracking-tight mb-2">
              Innovative solutions for business success from today
            </motion.h2>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-6 border-y border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-[#eef0ee] text-[#6B6E70] px-4 py-1.5 rounded-[6px] text-[13px] font-bold hover:bg-[#86C232] hover:text-white transition-colors cursor-pointer">Design</span>
            ...
            <motion.div variants={fadeUp} className="w-full bg-[#eef0ee] rounded-[16px] mt-10 mb-14 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between px-8 py-6 relative">
                ...
                <div className="w-1/3 flex justify-start">
                  <Link href="/blogpage8" className="flex items-center gap-3 text-[#222629] font-extrabold text-[16px] hover:text-[#86C232] group transition-colors">
