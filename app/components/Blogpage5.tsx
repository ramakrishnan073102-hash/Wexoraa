...
const CATEGORIES = [
  ...
  { name: "Managements", count: "01", active: true }, 
...
/* ──────────────────────────────────────────────────────────
   MAIN COMPONENT — BLOG DETAILS PAGE 5
────────────────────────────────────────────────────────── */
export default function Blogpage5(): React.ReactElement {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-[2.2rem] md:text-[2.8rem] font-extrabold text-[#222629] leading-[1.2] tracking-tight mb-2">
              Proven Lessons for Effective Change Management in Business
            </motion.h2>
            ...
            <motion.div variants={fadeUp}>
              <h3 className="text-[2rem] font-extrabold text-[#222629] leading-tight mb-6">
                Key lessons of Business Potential
              </h3>
