  ...
  return (
    <main className="w-full bg-[#f0f2f0] font-['Manrope',_sans-serif] min-h-screen pb-20 md:pb-28">
      ...
      <section className="w-full pt-4 sm:pt-6 lg:pt-8 px-4 sm:px-6 lg:px-8 mb-12 md:mb-20">
        <div className="relative w-full max-w-[1400px] mx-auto h-[320px] md:h-[420px] lg:h-[480px] rounded-[10px] flex items-center justify-center overflow-hidden">
          {/* Background image */}
          <div
          ...
          />
          {/* Dark teal overlay — matching the video's deep green-dark tint */}
          ...
          <div className="relative z-20 flex flex-col items-center text-center px-4 w-full">
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-[3.8rem] font-extrabold text-white mb-6 tracking-tight leading-tight"
            >
            ...
            <motion.div
              ...
              className="flex items-center gap-1.5 sm:gap-2 text-[14px] sm:text-[15px] font-medium text-white/75 bg-[#222629]/50 backdrop-blur-sm px-5 py-2.5 rounded-full border border-white/10 w-fit"
            >
