...
const CATEGORIES = [
  ...
  { name: "Consulting", count: "02", active: true }, // Active category for this post
  { name: "Innovations", count: "01", active: false },
  { name: "Managements", count: "01", active: false },
  { name: "Marketing", count: "01", active: false },
];

const TAGS = ["Consulting", "Change", "Leadership", "Management", "Strategy"];
...
/* ──────────────────────────────────────────────────────────
   MAIN COMPONENT — BLOG DETAILS PAGE 3
────────────────────────────────────────────────────────── */
export default function Blogpage3(): React.ReactElement {
    ...
    <main className="w-full bg-[#f8f9f8] font-['Manrope',_sans-serif] min-h-screen pb-20 md:pb-28">
      ...
      <section className="max-w-[1300px] mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            {/* Featured Image - Different for the 3rd post */}
            ...
            <motion.div variants={fadeUp} className="space-y-6 text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-10">
              <p>
                In today's competitive landscape, businesses must continuously adapt and innovate to thrive. Mastering Change Management means navigating transitions smoothly and leveraging innovative solutions to drive growth, enhance efficiency, and foster lasting success. At [Company Name], we believe that adapting to change is not just about reacting—it's about preparing proactively. By harnessing cutting-edge technologies, data-driven insights, and creative problem-solving, we provide businesses with the tools needed to stay ahead.
              </p>
              <p>
                The curve. Whether you're looking to streamline operations, enhance customer experiences, or explore new market opportunities, our tailored solutions are designed to empower your business to achieve unparalleled success. With a focus on sustainability, scalability, and adaptability, we help your business navigate transitions effortlessly.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="relative bg-[#eef0ee] border-l-[4px] border-[#86C232] py-10 px-10 md:px-14 rounded-r-[16px] mb-4 overflow-hidden">
              ...
              <p className="relative z-10 text-[1.25rem] md:text-[1.4rem] font-extrabold text-[#222629] leading-[1.6] mb-4 italic">
                Change is the law of life. And those who look only to the past or present are certain to miss the future. Innovation is the catalyst that transforms ideas into reality.
              </p>
            ...
            <motion.div variants={fadeUp}>
              <h3 className="text-[2rem] font-extrabold text-[#222629] leading-tight mb-6">
                Kye lessons of Change Management
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div className="h-[320px] rounded-[16px] overflow-hidden shadow-sm">
                  <img src="https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=800&q=80" alt="Business Women" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <div className="h-[320px] rounded-[16px] overflow-hidden shadow-sm">
                  <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=800&q=80" alt="Business Man Writing" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </div>
            ...
            <motion.div variants={fadeUp}>
              ...
              <p className="text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-6">
                Mastering change is a journey that requires vision, innovation, and strategic execution. By embracing key lessons such as leveraging data, focusing on customer experience, fostering adaptability, and nurturing effective leadership, businesses can thrive in an ever-evolving marketplace.
              </p>
              <p className="text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-10">
                The ability to continuously learn, collaborate, and optimize operations will not only drive growth but ensure long-term sustainability. Remember, the path to success is not linear, but preparedness makes all the difference.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-6 border-y border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-[#eef0ee] text-[#6B6E70] px-4 py-1.5 rounded-[6px] text-[13px] font-bold hover:bg-[#86C232] hover:text-white transition-colors cursor-pointer">Consulting</span>
            ...
            <motion.div variants={fadeUp} className="w-full bg-[#eef0ee] rounded-[16px] mt-10 mb-14 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between px-8 py-6 relative">
                ...
                <div className="w-1/3 flex justify-start">
                  <Link href="/blogpage2" className="flex items-center gap-3 text-[#222629] font-extrabold text-[16px] hover:text-[#86C232] group transition-colors">
                ...
                <div className="w-1/3 flex justify-end">
                  <Link href="/blogpage4" className="flex items-center gap-3 text-[#222629] font-extrabold text-[16px] hover:text-[#86C232] group transition-colors">
                    Next
                    <div className="w-12 h-12 rounded-full border border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-[#86C232] group-hover:bg-[#86C232] group-hover:text-white">
              ...
              <div className="flex flex-wrap gap-2.5">
                {TAGS.map((tag, idx) => (
                  <Link 
                    key={idx} 
                    href="#" 
                    className={`px-5 py-2.5 rounded-[8px] text-[14px] font-extrabold transition-all duration-300 shadow-sm border border-transparent ${
                      idx === 0 
                        ? 'bg-[#86C232] text-white' 
                        : 'bg-white text-[#6B6E70] hover:bg-[#86C232] hover:text-white'
                    }`}
                  >
                    {tag}
                  </Link>
