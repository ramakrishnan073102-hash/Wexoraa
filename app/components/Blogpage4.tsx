...
const CATEGORIES = [
  { name: "Corporate", count: "02", active: false },
  { name: "Business", count: "02", active: false },
  { name: "Consulting", count: "02", active: false },
  { name: "Innovations", count: "01", active: true }, // Active category for this post
  { name: "Managements", count: "01", active: false },
  { name: "Marketing", count: "01", active: false },
];

const TAGS = ["Marketing", "Growth", "Strategy", "Branding", "Analytics"];
...
const COMMENTS = [
  {
    id: 1,
    author: "Truly eye-opening article!",
    date: "January 12, 2026 at 09:30 am",
    avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=100&q=80",
    text: "The emphasis on data-driven decisions and omnichannel presence is spot-on. In our agency, we've seen firsthand how brands that unify their messaging across every touchpoint consistently outperform those that don't. Great, actionable insights here!",
  },
  {
    id: 2,
    author: "Refreshingly practical read",
    date: "January 14, 2026 at 11:15 am",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80",
    text: "Most marketing content stays theoretical, but this piece gives you a real framework to act on. The section on agile campaigns particularly resonated — the ability to pivot fast is everything in today's landscape. Keep it coming!",
  },
];
...
/* ──────────────────────────────────────────────────────────
   MAIN COMPONENT — BLOG DETAILS PAGE 4
────────────────────────────────────────────────────────── */
export default function Blogpage4(): React.ReactElement {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-[2.2rem] md:text-[2.8rem] font-extrabold text-[#222629] leading-[1.2] tracking-tight mb-2">
              Winning Marketing Strategies to Accelerate Business Growth
            </motion.h2>
            ...
            <motion.div variants={fadeUp} className="space-y-6 text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-10">
              <p>
                In an era defined by digital noise and shrinking attention spans, businesses that win are those who market with precision and purpose. A winning marketing strategy is no longer about shouting the loudest — it's about speaking directly to the right audience, at the right moment, through the right channel. At its core, modern marketing is a science as much as it is an art, requiring a seamless blend of creativity, analytics, and agility.
              </p>
              <p>
                Whether you're a growing startup or an established enterprise, the fundamentals remain the same: understand your customer deeply, craft a compelling brand narrative, and execute campaigns that are measurable, adaptable, and human. The businesses that thrive are those that treat marketing not as a department, but as an organization-wide discipline.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="relative bg-[#eef0ee] border-l-[4px] border-[#86C232] py-10 px-10 md:px-14 rounded-r-[16px] mb-4 overflow-hidden">
              ...
              <p className="relative z-10 text-[1.25rem] md:text-[1.4rem] font-extrabold text-[#222629] leading-[1.6] mb-4 italic">
                Marketing is no longer about the stuff that you make, but about the stories you tell. The brands that earn trust win markets — not just transactions.
              </p>
            ...
            <motion.div variants={fadeUp}>
              <h3 className="text-[2rem] font-extrabold text-[#222629] leading-tight mb-6">
                Key Pillars of a High-Impact Marketing Strategy
              </h3>
              <p className="text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-8">
                Building a marketing engine that consistently delivers results requires more than clever campaigns. It demands a structured approach built on clear pillars: knowing who you're targeting, what you stand for, and how you'll reach and retain customers. Great marketing teams obsess over data, iterate rapidly, and never lose sight of the human behind every conversion metric.
              </p>

              {/* 2-Image Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div className="h-[320px] rounded-[16px] overflow-hidden shadow-sm">
                  <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" alt="Marketing Analytics" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <div className="h-[320px] rounded-[16px] overflow-hidden shadow-sm">
                  <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&w=800&q=80" alt="Content Strategy" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </div>

              <p className="text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-10">
                From building a consistent brand identity that resonates across every touchpoint, to harnessing performance analytics that reveal what's truly working — the most successful marketing strategies are living systems. They evolve with market trends, customer feedback, and competitive shifts, ensuring businesses stay not just relevant, but indispensable.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              ...
              <p className="text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-6">
                A winning marketing strategy is never a one-size-fits-all solution. It's a carefully crafted, continuously refined system that aligns your brand's unique strengths with the evolving needs of your target audience. By anchoring every initiative in data, maintaining brand consistency, and staying agile in execution, businesses can build marketing engines that don't just generate leads — they build lasting loyalty.
              </p>
              <p className="text-[#6B6E70] text-[16px] leading-[1.85] font-medium mb-10">
                The future belongs to brands that listen as well as they speak, that measure as passionately as they create, and that put their customer at the center of every decision. Start with purpose, execute with precision, and never stop learning from the market.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-6 border-y border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-[#eef0ee] text-[#6B6E70] px-4 py-1.5 rounded-[6px] text-[13px] font-bold hover:bg-[#86C232] hover:text-white transition-colors cursor-pointer">Growth</span>
              </div>
              <div className="flex items-center gap-4">
            ...
            <motion.div variants={fadeUp} className="w-full bg-[#eef0ee] rounded-[16px] mt-10 mb-14 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between px-8 py-6 relative">
                ...
                <div className="w-1/3 flex justify-start">
                  <Link href="/blogpage3" className="flex items-center gap-3 text-[#222629] font-extrabold text-[16px] hover:text-[#86C232] group transition-colors">
                ...
                <div className="w-1/3 flex justify-end">
                  <Link href="/blogpage5" className="flex items-center gap-3 text-[#222629] font-extrabold text-[16px] hover:text-[#86C232] group transition-colors">
                    Next
                    <div className="w-12 h-12 rounded-full border border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-[#86C232] group-hover:bg-[#86C232] group-hover:text-white">
