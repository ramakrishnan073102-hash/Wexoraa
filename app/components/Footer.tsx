...
/* ─────────────────────────────────────────────
   SIMPLE FOOTER LINK (Responsive Big Font)
───────────────────────────────────────────── */
function FooterLink({
  href,
  label,
    ...
    <>
      <footer className="relative overflow-hidden bg-[#EEF3EE] font-['Manrope',_sans-serif]">
        <div className="relative z-10 max-w-[1340px] mx-auto px-5 sm:px-6 lg:px-8 pt-16 md:pt-28 pb-10">
          ...
          ═══════════════════════════════════════════ */}
          <div
            className="relative overflow-hidden rounded-[20px] md:rounded-[24px] mb-16 md:mb-24 min-h-[320px] md:min-h-[450px] flex flex-col items-center justify-center bg-[#F2F6F3]"
          >
            {/* Soft Green Glow */}
            ...
            <div className="relative z-30 flex flex-col items-center text-center p-6 sm:p-12 w-full">
              ...
              <div className="w-full flex justify-center">
                ...
                >
                  {/* Overlapping Avatars (Scaled for mobile) */}
                  <div className="flex -space-x-3 lg:-space-x-4">
                    <img 
                      src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&q=80&w=150" 
                      alt="Team 1" 
                      className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full border-[2.5px] lg:border-[3px] border-[#222629] group-hover:border-[#86C232] transition-colors object-cover relative z-30" 
                    />
                    <img 
                      src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=150" 
                      alt="Team 2" 
                      className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full border-[2.5px] lg:border-[3px] border-[#222629] group-hover:border-[#86C232] transition-colors object-cover relative z-20" 
                    />
                    <img 
                      src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=150" 
                      alt="Team 3" 
                      className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full border-[2.5px] lg:border-[3px] border-[#222629] group-hover:border-[#86C232] transition-colors object-cover relative z-10" 
                    />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-10 md:gap-8 mb-16 md:mb-20">
            ...
            <div className="flex flex-col items-start text-left pr-0 md:pr-8">
              ...
              <p className="text-[#6B6E70] leading-[1.7] md:leading-[1.8] text-[14px] md:text-[15px] max-w-[320px] font-medium text-left">
          ...
          <div className="pt-8 border-t border-[#474B4F]/15 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 lg:gap-10">
              ...
              {/* Copyright */}
              <div className="text-[#6B6E70] text-[13px] md:text-[15px] font-medium text-left">
